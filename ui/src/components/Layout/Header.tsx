...
const navigation: NavigationItem[] = [
  { name: "Dashboard", to: "ucs/dashboard", current: true },
  { name: "Inscrits", to: "ucs/inscrits", current: false },
  { name: "valider", to: "ucs/valider", current: false },
  { name: "Fiche", to: "ucs/fiche", current: false },
  { name: "Rapport", to: "ucs/rapport", current: false },
];
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              ...
              <span className="text-neutral">GS Joana</span>
            </div>
