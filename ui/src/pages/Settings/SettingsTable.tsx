...
const SettingsTable: React.FC = () => {
  ...
  const tabs: Tab[] = [
    // { title: "Nouveau", content: <RegisterPage /> },
    // { title: "Administration", content: <UsersPage /> },
    // { title: "Clinique", content: <ClinicPage /> },
    // { title: "Services", content: <ServicePage /> },
    // { title: "Examens", content: <ExamPage /> },
    { title: "Rapports", content: null },
  ];
