...
const ResultTable: React.FC = () => {
  ...
  const tabs: Tab[] = [
    // { title: "Fiche", content: <FichesPage /> },
    // { title: "Receptions", content: <ReceptionPage /> },
    // { title: "Hospitalisation", content: <HospitalisationPage /> },
    { title: "SITUATION", content: <Dashboard /> },
    { title: "RESULTATS", content: <VoteCand /> },
  ];
